...
let repeatStr94 = "row row row your boat";
...
let repeatRegex94 = /(\w+) \1 \1/;
repeatRegex94.test(repeatStr94); // Returns true
repeatStr94.match(repeatRegex94); // Returns ["row row row", "row"]
console.log(repeatStr94.match(repeatRegex94));
